...
//   return {
//     title: `${query}在线网盘资源搜索下载 - 焦木盘搜`,
//     description: `焦木盘搜是一个一站式网盘资源搜索引擎，支持夸克网盘、百度网盘、阿里云盘等多平台，快速精准搜索，一键直达`,
//   };
// };
		...
		<div className="container mx-auto py-6 text-base">
			...
			<Alert className="mb-6 bg-amber-50 border-amber-200">
				...
				<AlertDescription className="text-amber-700">
					资源一定要转到{resource.diskType}网盘方可观看全部，否则只能观看2分钟的试片，{resource.diskType}还可以投屏！资源不对的话添加微信
					chui89520 免费帮找!
				</AlertDescription>
			</Alert>
